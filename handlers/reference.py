...
def register_reference_handler(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(reference_link_generate, lambda call: call.data == "generate_link")
    dp.register_callback_query_handler(reference_list_owner, lambda call: call.data == "referral_list")
